...
def main(t):
	time.sleep(t)
	logo()
	print("[1] Заспамить жертву :)")
	print("[2] Обновить sms bomber.")
	print("[3] Выйти.\n")
	input1 = input(Style.BRIGHT+Fore.BLUE+"Пожалуйста, введите номер пункта: "+Style.RESET_ALL)
	...
	if input1 == "1":
		logo()
		phone = input(Style.BRIGHT+Fore.BLUE+"Пожалуйста, введите номер телефона для атаки: "+Style.RESET_ALL)
		if phone == "":
			main(0)
		if phone[0] == "+":
			phone = phone[1:]
		...
		logo()
		update = input(Style.BRIGHT+Fore.BLUE+"Вы уверены, что хотите обновить sms bomber? "+Style.RESET_ALL+"(y/n) ")
		if update == "y":
			os.system("cd && rm -rf ~/smsbomber && git clone https://github.com/NiKoTiN228/smsbomber.git && python ~/smsbomber/install.py")
			exit()
		else:
			logo()
		...
		logo()
		print(Style.BRIGHT+Fore.RED+"[!] Неправильный номер пункта :("+Style.RESET_ALL)
		main(1)
